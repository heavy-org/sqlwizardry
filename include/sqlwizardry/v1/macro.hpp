...
constexpr static sqlwizardry::ColumnDefinition<_class_id,SQLWIZARDRY_COLUMN_TYPE(x)> SQLWIZARDRY_COLUMN_NAME(x){BOOST_PP_STRINGIZE(SQLWIZARDRY_COLUMN_NAME(x))};
